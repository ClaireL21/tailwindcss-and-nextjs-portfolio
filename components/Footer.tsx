...
const Footer = () => {
    return (
        <footer className="mx-auto max-w-3xl mt-40 px-4 sm:px-6 md:max-w-5xl">
            <hr className="w-full h-0.5 mx-auto mt-9=8 bg-neutral-200 border-0"></hr>
            <div className="mx-auto p-4 flex flex-col text-center text-neutral-900 md:flex-row md:justify-between">
                <div className="text-neutral-500">© 2023 Claire Lu</div>
